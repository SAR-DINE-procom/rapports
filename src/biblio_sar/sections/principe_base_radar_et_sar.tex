...
[TODO] : Refaire la figure avec tikz pcq en natif c'est nul
\begin{figure}[htbp]
    \centering
    ...
    \put(0.15,0.125){\line(0,1){0.25}}
    \put(0.15,0.25){\line(1,0){0.5}}
    \put(0.65,0.125){\line(0,1){0.25}}
    \put(0.25,0.75){\makebox(0,0)[b]{$\tau_{e}$}}
        % Ligne entre les deux impulsions
    \put(1.9,1.5){\line(1,0){2}}
    \put(1.9,1.375){\line(0,1){0.25}}
    \put(3.9,1.375){\line(0,1){0.25}}
    \put(3,1.75){\makebox(0,0)[b]{$T_{s}$}}
        % Ligne verticale pour delta f
    \put(7,0.6){\line(0,1){0.5}}
    \put(6.875,0.6){\line(1,0){0.25}}
    \put(6.875,1.1){\line(1,0){0.25}}
    \put(7.25,0){\makebox(0,0)[b]{$\Delta f = f_b$}}
    % Ligne vertical pour Bch
    \put(9,0){\line(0,1){2}}
    \put(8.875,0){\line(1,0){0.25}}
    \put(8.875,2){\line(1,0){0.25}}
    \put(8.7,1.5){\makebox(0,0)[b]{$B_{ch}$}}
    }
    \end{picture}
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[label/.style={font=\small}]
        ...
        \draw[blue, thick] (0,0) -- (\Tr/2, \Amp) -- (\Tr, 0) -- (1.5*\Tr, \Amp) -- (2*\Tr, 0);
