...
\hypersetup{
	pdfinfo = {
		...
		Title = {Étude sur l'architecture matérielle et le traitement en imagerie SAR pour plateformes autonomes multi-capteurs},
		Keywords = {SAR;RSO;imagerie;cartographie;drone;UAV;essaim de drones;système;backprojection;autofocus;CA-CFAR;fusion de données;détection multicapteurs; multicapteurs; multi-capteurs; mise en réseau; antenne; radar }
	}
}
...
\tikzset{
    ...
    % Styles spécifiques (Image SAR)
    io/.style={rectangle, minimum width=2.5cm, minimum height=0.8cm, text centered, draw=none, fill=red, text=white, font=\bfseries},
    cyanblock/.style={rectangle, minimum width=2.5cm, minimum height=0.8cm, text centered, fill=cyan},
    yellowblock/.style={rectangle, minimum width=2.5cm, minimum height=0.8cm, text centered, fill=orange!80!yellow},
    darkblue/.style={rectangle, minimum width=2.5cm, minimum height=0.8cm, text centered, fill=blue!80!black, text=white}
}
%---------------------------------------------------------------------------------------------
...
\title{SAR'DINE : étude d'un système de radar à synthèse d'ouverture en bande K}
...
\supervisors{Dr. François GALLEE, Dr. Frédéric MAUSSANG, 
Dr. Jean Marc LE CAILLEC, Dr. Dominique PASTOR, Dr. Christophe SINTES}
...
\include{src/rapport_complet/sections/etat_de_lart}
    ...
    \include{src/rapport_complet/sections/etat_de_lart/RF/Acquisition_Image}
    \include{src/rapport_complet/sections/etat_de_lart/RF/stockage-données-SAR}
    \include{src/rapport_complet/sections/etat_de_lart/RF/sar_commerciaux}
...
\include{src/rapport_complet/sections/projet}
    \include{src/rapport_complet/sections/projet/rf/choixRF}
    \include{src/rapport_complet/sections/projet/traitement/backprojection}
    \include{src/rapport_complet/sections/projet/traitement/autofocus}
    \include{src/rapport_complet/sections/projet/traitement/simulateur}
    
    \include{src/rapport_complet/sections/projet/traitement/detection}
    %\include{src/rapport_complet/sections/projet/traitement/choix_algo} 
    
    

    \include{src/rapport_complet/sections/projet/problemes/PB_sauvegardeIQ_&_SelfMixing} 
    \include{src/rapport_complet/sections/projet/misc/3D} 
    \include{src/rapport_complet/sections/projet/misc/tests_dev} 

    \include{src/rapport_complet/sections/projet/res}
    \include{src/rapport_complet/sections/projet/conclusion}

    % \include{src/rapport_complet/sections/projet/gestion_projet}
    %     \include{src/rapport_complet/sections/projet/gestion_projet/risques}
    %     \include{src/rapport_complet/sections/projet/gestion_projet/risques_completes}
