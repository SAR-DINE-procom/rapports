...
\subsubsection{Principe du CA-CFAR (cell-averaging Constant False Alarm Rate)}
...
\paragraph{Calcul du seuil de détection}
...
\paragraph{Probabilité de fausse alarme et Probabilité de détection}

\subparagraph{Probabilité de fausse alarme (\(P_{\text{fa}}\))}  
...
\subparagraph{Probabilité de détection (\(P_{\text{d}}\))}  
