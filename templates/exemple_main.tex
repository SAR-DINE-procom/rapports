...
\title{SAR'DINE : imagerie radar à synthèse d'ouverture (RSO) par des plateformes autonomes multicapteurs}
...
Exemple de 2 équations éditées dans 2 blocs de style \emph{Beamer} sur 2 colonnes : Une bouzasse monumentale 
